...
function TopHeader() {
  ...
  return (
    <div>
      ...
      >
        <Navbar.Brand onClick={() => Tohome()}>Y-Kart </Navbar.Brand>
        ...
        >
          <Nav className="me-auto">
            ...
            <Nav.Link onClick={() => Toallproduct()}>All Product</Nav.Link>
            <Nav.Link onClick={() => Tolaptop()}>Laptops</Nav.Link>
            <Nav.Link onClick={() => Towatch()}>Watches</Nav.Link>
            <Nav.Link onClick={() => Totablet()}>Tablets</Nav.Link>
            <Nav.Link onClick={() => Tosmartphone()}>Smart Phones</Nav.Link>
            <Nav.Link onClick={() => Toelectronics()}>others</Nav.Link>
          </Nav>
          <Nav.Item>
